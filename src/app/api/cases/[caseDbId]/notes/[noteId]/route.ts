...
export async function PATCH(
  ...
  return withActionLog("api/cases/[caseDbId]/notes/[noteId]/route.ts:PATCH", await context.params, async () => {
...
export async function DELETE(
  ...
  return withActionLog("api/cases/[caseDbId]/notes/[noteId]/route.ts:DELETE", await context.params, async () => {
    const user = await getCurrentUser();
    if (!user) return jsonError(401, "auth");
